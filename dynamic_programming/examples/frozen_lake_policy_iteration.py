"""
Simple script showing Policy Iteration - starting from random policy and
ending with optimal one.
"""
import os
import time
...
def find_optimal_policy_by_policy_iteration(
        gamma: float = 0.9,
        iterations: int = 10,
    ...
    agent.policy_iteration(iterations=iterations)
    return agent
...
def main():
    ...
    my_agent = find_optimal_policy_by_policy_iteration()
